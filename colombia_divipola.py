# Catálogo departamentos y municipios de Colombia (uso formularios EduTrack)
...
def lista_departamentos():
    return sorted(COLOMBIA_DEPARTAMENTOS.keys())

def municipios_de(departamento):
    return COLOMBIA_DEPARTAMENTOS.get(departamento or "", [])

def options_departamentos(selected=""):
...
def options_municipios(departamento, selected=""):
    opts = '<option value="">— Municipio —</option>'
    for m in municipios_de(departamento):
